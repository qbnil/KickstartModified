...
require('lazy').setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
        ...
        config = function()
            ...
            vim.keymap.set('n', '<leader>fst', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
            vim.keymap.set('n', '<leader>fwt', builtin.grep_string, { desc = '[S]earch current [W]ord' })
            vim.keymap.set('n', '<leader>fwn', builtin.live_grep, { desc = '[S]earch by [G]rep' })
